...
$Snake1_2 = GUICtrlCreatePic(@ScriptDir & "\Snake.bmp", $x2, $y10, 30, 30, -1, $WS_EX_TOPMOST)
$Snake2_2 = GUICtrlCreatePic(@ScriptDir & "\Snake.bmp", $x7, $y10, 30, 30, -1, $WS_EX_TOPMOST)
$Gem1_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x4, $y1, 30, 30, -1, $WS_EX_TOPMOST)
$Gem2_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x10, $y1, 30, 30, -1, $WS_EX_TOPMOST)
$Gem3_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x1, $y4, 30, 30, -1, $WS_EX_TOPMOST)
$Gem4_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x8, $y6, 30, 30, -1, $WS_EX_TOPMOST)
$Gem5_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x3, $y7, 30, 30, -1, $WS_EX_TOPMOST)
$Gem6_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x2, $y8, 30, 30, -1, $WS_EX_TOPMOST)
$Gem7_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x1, $y10, 30, 30, -1, $WS_EX_TOPMOST)
$Gem8_2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x8, $y10, 30, 30, -1, $WS_EX_TOPMOST)
...
While 1
	If $Start2 = 0 Then
		...
		Select
			Case $msg2 = $Password
				$Pass2 = InputBox("Level Password", "Enter the password for the level you want to skip to:")
