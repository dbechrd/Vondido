...
$Gem1 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x3, $y1, 30, 30, -1, $WS_EX_TOPMOST)
$Gem2 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x6, $y1, 30, 30, -1, $WS_EX_TOPMOST)
$Gem3 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x10, $y3, 30, 30, -1, $WS_EX_TOPMOST)
$Gem4 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x1, $y6, 30, 30, -1, $WS_EX_TOPMOST)
$Gem5 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x6, $y8, 30, 30, -1, $WS_EX_TOPMOST)
$Gem6 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x3, $y10, 30, 30, -1, $WS_EX_TOPMOST)
$Gem7 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x5, $y10, 30, 30, -1, $WS_EX_TOPMOST)
$Gem8 = GUICtrlCreatePic(@ScriptDir & "\Diamond.bmp", $x10, $y1, 30, 30, -1, $WS_EX_TOPMOST)
...
GuiSetState()
MsgBox(0, "Welcome!", "Press ""F2"" to begin playing the game.")
While Not $Paused
	$msg = GuiGetMsg()
